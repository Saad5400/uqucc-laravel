            ...
            <CardContent size="sm">
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <Input id="weighted-score" v-model="weightedScore" type="text" placeholder="مثال: 99" variant="visible" class="text-base" />
                    </div>
                    <div>
                        <Label for="cumulative-gpa" class="!mb-2 block">المعدل التراكمي</Label>
                        <Input id="cumulative-gpa" v-model="cumulativeGpa" type="text" placeholder="مثال: 3.7" variant="visible" class="text-base" />
                    </div>
                </div>
            </CardContent>
        </Card>
