...
- ✅ **pages table** - Stores all content with hierarchy support
  - Fields: id, slug, title, html_content, order, icon, hidden, parent_id, level, extension, quick_response_enabled, quick_response_send_link, quick_response_message, quick_response_button_label, quick_response_button_url, quick_response_attachments
