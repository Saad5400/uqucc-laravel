...
class PageChangeRequestController extends Controller
{
    ...
    private const FIELD_LABELS = [
        ...
        'quick_response_message' => 'نص رد البوت',
        'quick_response_buttons' => 'أزرار رد البوت',
        'quick_response_attachments' => 'مرفقات رد البوت',
        'quick_response_auto_extract_message' => 'نص الرد من محتوى الصفحة',
        'quick_response_auto_extract_buttons' => 'أزرار الرد من روابط الصفحة',
        'quick_response_auto_extract_attachments' => 'مرفقات الرد من صور الصفحة',
        'quick_response_send_link' => 'ربط العنوان بالصفحة',
    ];
