...
class ReorderPrivateTutorCoursesRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'ids.*' => ['integer', 'distinct', 'exists:private_tutor_courses,id'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'ids.*.integer' => 'معرّف المقرر غير صالح.',
            'ids.*.distinct' => 'قائمة الترتيب تحتوي على معرّف مكرر.',
            'ids.*.exists' => 'أحد المقررات في قائمة الترتيب غير موجود.',
        ];
    }
}
