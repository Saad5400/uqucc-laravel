...
class ReorderCohortsRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'ids.*' => ['integer', 'distinct', 'exists:student_cohorts,id'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'ids.*.integer' => 'معرّف الدفعة غير صالح.',
            'ids.*.distinct' => 'قائمة الترتيب تحتوي على معرّف مكرر.',
            'ids.*.exists' => 'إحدى الدفعات في قائمة الترتيب غير موجودة.',
        ];
    }
}
