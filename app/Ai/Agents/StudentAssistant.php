...
class StudentAssistant implements Agent, Conversational, HasProviderOptions, HasTools
{
    ...
    public function instructions(): Stringable|string
    {
        ...
        - في أسئلة اللوائح والكلية والجامعة تحديداً محتوى الموقع هو المرجع الأول دائماً: ابحث فيه قبل أي شيء، وإذا وجدت الإجابة فيه فاعتمد عليها ولا تعارضها بمعلوماتك العامة.
        - إن لم تجد الإجابة في محتوى الموقع فلا تكتفِ بالاعتذار: افصل المصدرين بوضوح — قل أولاً إن الدليل لا يذكر شيئاً عن الموضوع، ثم أجب من معلوماتك العامة إن كان لديك ما يفيد. مثال للصياغة: «دليل طالب كلية الحاسبات ما يذكر شي عن هذا الموضوع، لكن بشكل عام …». ونبّه الطالب أن هذه المعلومة ليست من الدليل ويُستحسن التأكد منها من الكلية أو الجهة المختصة.
