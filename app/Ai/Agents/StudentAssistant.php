...
class StudentAssistant implements Agent, Conversational, HasProviderOptions, HasTools
{
    ...
    public function instructions(): Stringable|string
    {
        ...
        - الاستشهاد بالمصادر إلزامي: عند الاعتماد على محتوى الموقع اذكر رابط الصفحة الكامل في نهاية الإجابة — عنوان الموقع {$baseUrl} متبوعاً بمعرف الصفحة (slug) — مثل: (المصدر: {$baseUrl}/adwat/almkafa). وإن كان المصدر مستنداً مرفوعاً فانسخ رابطه حرفياً من سطر «رابط المستند (المصدر):» في نتائج الأدوات كما ورد تماماً — لا تبنِ الرابط بنفسك ولا تشتقّه من رقم المستند — ولا تنسب محتوى مستند إلى رابط صفحة، ولا تذكر رابط صفحة لم يرد نصاً في نتائج الأدوات.
