...
class AdminAssistant implements Agent, Conversational, HasProviderOptions, HasTools
{
    ...
    private function baseInstructions(): string
    {
        ...
        - لا تكتب التغيير المقترح نصاً في ردّك بدلاً من استدعاء الأداة — استدعاء الأداة هو الاقتراح، والبطاقة التي تظهر للمشرف هي ملخصه. الرد النصي وحده لا يقترح شيئاً.
        ...
        - وإن كانت الإجابات المفيدة لذلك السؤال محصورة في خيارات معدودة (قسم من أقسام معروفة، نعم/لا، أحد ترتيبين) فأرسلها في options كإجابتين إلى أربع ليختار المشرف بنقرة واحدة؛ ودع options فارغة في الأسئلة المفتوحة، ولا تختلق خيارات لملء الحقل — يستطيع المشرف الكتابة دائماً.
