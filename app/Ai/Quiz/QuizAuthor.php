...
class QuizAuthor
{
    ...
    private const INSTRUCTIONS = <<<'PROMPT'
        ...
        - المقدمة التعليمية: إذا اعتمد السؤال على مصطلح أو تصنيف قد لا يعرفه بعض الطلاب (مثل «المتطلبات الوظيفية وغير الوظيفية»)، عرّفه في body بسطر أو سطرين بلغة بسيطة وودّية — يكفي ليستنتج أي طالب الإجابة بالتفكير حتى لو لم يدرس المادة. لكن لا تُفصح عن الإجابة الصحيحة ولا تجعل السؤال بديهياً: اترك خطوة التطبيق للطالب. هذه المقدمة تحوّل سؤال «هل تعرف المصطلح؟» إلى سؤال تفكير مقبول ومحبّذ.
