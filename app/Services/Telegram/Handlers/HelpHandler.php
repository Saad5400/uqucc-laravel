...
<b>🧮 أدوات:</b>
• جدول الصواب [صيغة منطقية]
  مثال: جدول الصواب p and q -> r
• حول [عدد] من [أساس] إلى [أساس]
  مثال: حول 2AF من 16 إلى 2
  ويقبل الأسماء: ثنائي، ثماني، عشري، ست عشري

<b>👥 الفرق (في المجموعات):</b>
• انضم - اختر فرقك بالأزرار ✅
  ضغطة للانضمام، وضغطة أخرى للخروج
• الفرق - عرض فرق المجموعة
• فرقي - فرقك الحالية
• أعضاء [فريق] - قائمة الأعضاء
• انسحب [فريق] - انسحاب فوري
• انسحب من الكل - من جميع الفرق
• منشن فريق [اسم] - نداء الأعضاء
  عدة فرق معًا (تقاطع): منشن فرق أ + ب
• انضم [فريق] - طلب انضمام بالكتابة
  (يوافق مشرف بالرد «أضف» خلال 24 ساعة)

<b>🛡️ إدارة الفرق (لمشرفي المجموعة):</b>
• فريق جديد [اسم]
• فريق جديد [اسم] ضمن [تصنيف]
• حذف فريق [اسم]
• تصنيف جديد [اسم] - تصنيف للفرق
• حذف تصنيف [اسم] - تبقى فرقه
• صنف [فريق] ضمن [تصنيف]
• اختصار [فريق]: cs، سي اس
  اختصارات إضافية يستجيب لها الفريق
• حذف اختصار [اختصار]
• أضف - بالرد على رسالة «انضم»
• أزل [فريق] - بالرد على رسالة العضو

<b>🏆 سؤال اليوم:</b>
• المتصدرين - لوحة الأفراد والفرق
• نقاطي - نتيجتك وسلسلتك
• نقاط سؤال اليوم - كيف تُحسب النقاط

<b>📱 أوامر أخرى:</b>
• /info - معلومات البوت
• /help - هذه المساعدة
• رابط - دعوة صالحة 24 ساعة (في المجموعات)
HELP;
    }
